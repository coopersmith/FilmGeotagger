...
the React app's filmstrip, frame detail, candidate strip, map and timeline are in
([docs/m3-findings.md](docs/m3-findings.md)); overrides, keyboard, facts editing and batch confirm are next.
